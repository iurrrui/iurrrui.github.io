...
Architext is a prototype of a text editor that generates a multi-relational map and a timeline according to the text input. It allows people to construct non-sequential text structures by applying a syntax developed based on Markdown.
...
Using the social contract theory as sample content, the video below demonstrates one potential way information could be organized in Architext.
